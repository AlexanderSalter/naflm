...
array_push($coachingstaff['Horatio X. Schottenheim (Coaching Staff)']['races'],   T_RACE_DKHORNE);
array_push($coachingstaff['Hireling Sports-Wizard (Wizard)']['races'],   T_RACE_DKHORNE);
